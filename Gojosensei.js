...
const reply = (teks) => {
        ...
        const replay = (teks) => {
            ...
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` kingsley`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/gojo.jpg`),"sourceUrl": "https://telegra.ph/file/3dc8ead2776d65a3b0d02.jpg"}}}, { quoted: m})
...
break
                    ...
                    case 'bug': case 'report': {
                    	...
                    	GojoMdNx.sendMessage(`265889976968@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
